...
sudo service unicorn_propertyCross <start|stop|restart>
sudo service sidekiq_propertyCross <start|stop>
```
...
```
/home/deployer/apps/propertyCross/shared/.env.production
```

After making changes to this file, be sure to restart the application:

```
sudo service unicorn_propertyCross restart
sudo service sidekiq_propertyCross stop
sudo service sidekiq_propertyCross start
```
